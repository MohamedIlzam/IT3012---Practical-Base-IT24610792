...
class VisualGridHuntGame:
    ...
    def __init__(self, width=10, height=10, num_food=10, num_opponents=2, custom_walls=None, num_traps = 2):
        self.width = width
        self.height = height
        ...
        #generate toxic trap posdittion safely    
...
class GridGameGUI:
    ...
    def draw_grid(self):
        ...
        for tx, ty in self.env.toxic_traps:
            ...
            # Creating a purple rectangle to represent the trap
            self.canvas.create_rectangle(x1, y1, x1 + self.cell_size * 0.5, y1 + self.cell_size * 0.5, 
                                         fill="#9333ea", outline="#6b21a8", width=2)
